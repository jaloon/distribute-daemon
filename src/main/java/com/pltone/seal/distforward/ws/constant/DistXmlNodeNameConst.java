package com.pltone.seal.distforward.ws.constant;
...
public final class DistXmlNodeNameConst {
     ...
     * dlist的子节点名称
     */
    public static final String[] DLIST_CHILD_NODES = {
            NODE_4_01_DISTRIBUT_NO,
            NODE_4_02_EFFECT_DATE,
            NODE_4_03_VEHIC_NO,
            NODE_4_04_CARD_NO,
            NODE_4_05_BIN_NUM,
            NODE_4_06_DEPT_ID,
            NODE_4_07_DEPT_NAME,
            NODE_4_08_DEPOT_NO,
            NODE_4_09_DEPOT_NAME,
            NODE_4_10_DISTRIBUT_FLAG
    };
    /**
     * 有用的配送节点
     */
    public static final String[] USEFUL_DIST_NODES = {
            NODE_4_01_DISTRIBUT_NO,
            NODE_4_03_VEHIC_NO,
            NODE_4_05_BIN_NUM,
            NODE_4_06_DEPT_ID,
